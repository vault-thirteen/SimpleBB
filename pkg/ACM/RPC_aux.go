...
func (srv *Server) sendVerificationCodeForReg(email string, code string) (err error) {
	...
	var msg = fmt.Sprintf(srv.settings.SmtpModuleSettings.MessageBodyTemplateForReg, srv.settings.SystemSettings.SiteName, code)
...
func (srv *Server) sendVerificationCodeForEmailChange(email string, code string) (err error) {
	...
	var msg = fmt.Sprintf(srv.settings.SmtpModuleSettings.MessageBodyTemplateForEmailChange, code)
...
func (srv *Server) sendVerificationCodeForPwdChange(email string, code string) (err error) {
	...
	var msg = fmt.Sprintf(srv.settings.SmtpModuleSettings.MessageBodyTemplateForPwdChange, code)

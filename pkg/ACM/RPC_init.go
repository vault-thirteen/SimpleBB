...
func (srv *Server) initJsonRpcHandlers() (err error) {
	...
	err = srv.jsonRpcHandlers.RegisterMethod(ac.FuncChangePassword, ChangePasswordHandler{Server: srv}, am.ChangePasswordParams{}, am.ChangePasswordResult{})
	if err != nil {
		return err
	}

	err = srv.jsonRpcHandlers.RegisterMethod(ac.FuncChangeEmail, ChangeEmailHandler{Server: srv}, am.ChangeEmailParams{}, am.ChangeEmailResult{})
	if err != nil {
		return err
	}

...
// Codes.
const (
	RpcErrorCode_RegisterUser_StepIsUnknown              = 1
	RpcErrorCode_RegisterUser_EmailAddresIsNotValid      = 2
	RpcErrorCode_RegisterUser_EmailAddresIsUsed          = 3
	RpcErrorCode_RegisterUser_VerificationCodeGenerator  = 4
	RpcErrorCode_RegisterUser_SmtpModule                 = 5
	RpcErrorCode_RegisterUser_VerificationCodeIsNotSet   = 6
	RpcErrorCode_RegisterUser_VerificationCodeIsNotValid = 7
	RpcErrorCode_RegisterUser_NameIsNotSet               = 8
	RpcErrorCode_RegisterUser_PasswordIsNotSet           = 9
	RpcErrorCode_RegisterUser_UserNameIsTooLong          = 10
	RpcErrorCode_RegisterUser_UserNameIsUsed             = 11
	RpcErrorCode_RegisterUser_PasswordError              = 12
	RpcErrorCode_BPP_PackSymbols                         = 13
	RpcErrorCode_RegisterUser_UserPasswordIsTooLong      = 14
	RpcErrorCode_LogUserIn_StepIsUnknown                 = 15
	RpcErrorCode_LogUserIn_UserCanNotLogIn               = 16
	RpcErrorCode_LogUserIn_UserIsAlreadyLoggedIn         = 17
	RpcErrorCode_LogUserIn_UserHasAlreadyStartedToLogIn  = 18
	RpcErrorCode_BPP_GenerateRandomSalt                  = 19
	RpcErrorCode_RCS_CreateCaptcha                       = 20
	RpcErrorCode_LogUserIn_RequestIdGenerator            = 21
	RpcErrorCode_LogUserIn_UserHasNotStartedToLogIn      = 22
	RpcErrorCode_LogUserIn_UserPreSessionIsNotFound      = 23
	RpcErrorCode_RCS_CheckCaptcha                        = 24
	RpcErrorCode_LogUserIn_CaptchaAnswerIsWrong          = 25
	RpcErrorCode_LogUserIn_PasswordIsWrong               = 26
	RpcErrorCode_LogUserIn_PasswordCheckError            = 27
	RpcErrorCode_LogUserIn_VerificationCodeGenerator     = 28
	RpcErrorCode_LogUserIn_VerificationCodeIsNotSet      = 29
	RpcErrorCode_LogUserIn_VerificationCodeIsWrong       = 30
	RpcErrorCode_LogUserIn_JWTCreation                   = 31
	RpcErrorCode_ThisActionIsNotForLoggedUsers           = 32
	RpcErrorCode_LogUserIn_EmailAddresIsNotValid         = 33
	RpcErrorCode_LogUserIn_RequestIdIsNotSet             = 34
	RpcErrorCode_LogUserIn_AuthChallengeResponseIsNotSet = 35
	RpcErrorCode_UserIdIsNotSet                          = 36
	RpcErrorCode_UserIsNotFound                          = 37
)

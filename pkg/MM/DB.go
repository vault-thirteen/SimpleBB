...
func (srv *Server) countRootSectionsM() (n int, err error) {
	err = srv.dbPreparedStatements[DbPsid_CountRootSections].QueryRow().Scan(&n)
	if err != nil {
...
func (srv *Server) insertNewSectionM(parent *uint, name string, creatorUserId uint) (lastInsertedId int64, err error) {
	...
	result, err = srv.dbPreparedStatements[DbPsid_InsertNewSection].Exec(parent, name, creatorUserId)
	if err != nil {
...
func (srv *Server) insertNewForumM(sectionId uint, name string, creatorUserId uint) (lastInsertedId int64, err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_InsertNewForum].Exec(sectionId, name, creatorUserId)
	if err != nil {
		return LastInsertedIdOnError, err
	}
...
func (srv *Server) countSectionsByIdM(sectionId uint) (n int, err error) {
	err = srv.dbPreparedStatements[DbPsid_CountSectionsById].QueryRow(sectionId).Scan(&n)
	if err != nil {
		return CountOnError, err
	}
...
func (srv *Server) countForumsByIdM(forumId uint) (n int, err error) {
	err = srv.dbPreparedStatements[DbPsid_CountForumsById].QueryRow(forumId).Scan(&n)
	if err != nil {
		return CountOnError, err
	}
...
func (srv *Server) getSectionChildrenByIdM(sectionId uint) (children *ul.UidList, err error) {
	children = ul.New()
	err = srv.dbPreparedStatements[DbPsid_GetSectionChildrenById].QueryRow(sectionId).Scan(children)
	if err != nil {
		return nil, err
	}
...
func (srv *Server) getSectionChildTypeByIdM(sectionId uint) (childType byte, err error) {
	err = srv.dbPreparedStatements[DbPsid_GetSectionChildTypeById].QueryRow(sectionId).Scan(&childType)
	if err != nil {
		return 0, err
	}
...
func (srv *Server) setSectionChildTypeByIdM(sectionId uint, childType byte) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetSectionChildTypeById].Exec(childType, sectionId)
	if err != nil {
		return err
	}
...
func (srv *Server) setSectionChildrenByIdM(sectionId uint, children *ul.UidList) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetSectionChildrenById].Exec(children, sectionId)
	if err != nil {
		return err
	}
...
func (srv *Server) setSectionNameByIdM(sectionId uint, name string, editorUserId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetSectionNameById].Exec(name, editorUserId, sectionId)
	if err != nil {
		return err
	}
...
func (srv *Server) setForumNameByIdM(forumId uint, name string, editorUserId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetForumNameById].Exec(name, editorUserId, forumId)
	if err != nil {
		return err
	}
...
func (srv *Server) setSectionParentByIdM(sectionId uint, parent uint, editorUserId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetSectionParentById].Exec(parent, editorUserId, sectionId)
	if err != nil {
		return err
	}
...
func (srv *Server) setForumSectionByIdM(forumId uint, sectionId uint, editorUserId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetForumSectionById].Exec(sectionId, editorUserId, forumId)
	if err != nil {
		return err
	}
...
func (srv *Server) getSectionParentByIdM(sectionId uint) (parent *uint, err error) {
	parent = new(uint)
	err = srv.dbPreparedStatements[DbPsid_GetSectionParentById].QueryRow(sectionId).Scan(&parent)
	if err != nil {
		return nil, err
	}
...
func (srv *Server) getForumSectionByIdM(forumId uint) (sectionId uint, err error) {
	err = srv.dbPreparedStatements[DbPsid_GetForumSectionById].QueryRow(forumId).Scan(&sectionId)
	if err != nil {
...
func (srv *Server) insertNewThreadM(parentForum uint, threadName string, creatorUserId uint) (lastInsertedId int64, err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_InsertNewThread].Exec(parentForum, threadName, creatorUserId)
	if err != nil {
		return LastInsertedIdOnError, err
	}
...
func (srv *Server) getForumThreadsByIdM(forumId uint) (threads *ul.UidList, err error) {
	threads = ul.New()
	err = srv.dbPreparedStatements[DbPsid_GetForumThreadsById].QueryRow(forumId).Scan(threads)
	if err != nil {
		return nil, err
	}
...
func (srv *Server) setForumThreadsByIdM(forumId uint, threads *ul.UidList) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetForumThreadsById].Exec(threads, forumId)
	if err != nil {
		return err
	}
...
func (srv *Server) setThreadNameByIdM(threadId uint, name string, editorUserId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetThreadNameById].Exec(name, editorUserId, threadId)
	if err != nil {
		return err
	}
...
func (srv *Server) getThreadForumByIdM(threadId uint) (forum uint, err error) {
	err = srv.dbPreparedStatements[DbPsid_GetThreadForumById].QueryRow(threadId).Scan(&forum)
	if err != nil {
		return IdOnError, err
	}
...
func (srv *Server) setThreadForumByIdM(threadId uint, forum uint, editorUserId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetThreadForumById].Exec(forum, editorUserId, threadId)
	if err != nil {
		return err
	}
...
func (srv *Server) countThreadsByIdM(threadId uint) (n int, err error) {
	err = srv.dbPreparedStatements[DbPsid_CountThreadsById].QueryRow(threadId).Scan(&n)
	if err != nil {
		return CountOnError, err
	}
...
func (srv *Server) getThreadMessagesByIdM(threadId uint) (messages *ul.UidList, err error) {
	messages = ul.New()
	err = srv.dbPreparedStatements[DbPsid_GetThreadMessagesById].QueryRow(threadId).Scan(messages)
	if err != nil {
		return nil, err
	}
...
func (srv *Server) insertNewMessageM(parentThread uint, messageText string, creatorUserId uint) (lastInsertedId int64, err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_InsertNewMessage].Exec(parentThread, messageText, creatorUserId)
	if err != nil {
		return LastInsertedIdOnError, err
	}
...
func (srv *Server) setThreadMessagesByIdM(threadId uint, messages *ul.UidList) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetThreadMessagesById].Exec(messages, threadId)
	if err != nil {
		return err
	}
...
func (srv *Server) setMessageTextByIdM(messageId uint, text string, editorUserId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetMessageTextById].Exec(text, editorUserId, messageId)
	if err != nil {
		return err
	}
...
func (srv *Server) getMessageThreadByIdM(messageId uint) (thread uint, err error) {
	err = srv.dbPreparedStatements[DbPsid_GetMessageThreadById].QueryRow(messageId).Scan(&thread)
	if err != nil {
		return IdOnError, err
	}
...
func (srv *Server) setMessageThreadByIdM(messageId uint, thread uint, editorUserId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_SetMessageThreadById].Exec(thread, editorUserId, messageId)
	if err != nil {
		return err
	}
...
func (srv *Server) getMessageCreatorAndTimeByIdM(messageId uint) (creatorUserId uint, ToC time.Time, ToE *time.Time, err error) {
	...
	err = srv.dbPreparedStatements[DbPsid_GetMessageCreatorAndTimeById].QueryRow(messageId).Scan(&creatorUserId, &ToC, &ToE)
	if err != nil {
...
func (srv *Server) getMessageByIdM(messageId uint) (message *mm.Message, err error) {
	...
	err = srv.dbPreparedStatements[DbPsid_GetMessageById].QueryRow(messageId).Scan(
		&message.Id,
		&message.ThreadId,
		&message.Text,
...
func (srv *Server) deleteMessageByIdM(messageId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_DeleteMessageById].Exec(messageId)
	if err != nil {
		return err
	}
...
func (srv *Server) getThreadByIdM(threadId uint) (thread *mm.Thread, err error) {
	thread = mm.NewThread()
	err = srv.dbPreparedStatements[DbPsid_GetThreadByIdM].QueryRow(threadId).Scan(
		&thread.Id,
		&thread.ForumId,
		&thread.Name,
		&thread.Messages,
...
func (srv *Server) deleteThreadByIdM(threadId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_DeleteThreadById].Exec(threadId)
	if err != nil {
		return err
	}
...
func (srv *Server) getForumByIdM(forumId uint) (forum *mm.Forum, err error) {
	forum = mm.NewForum()
	err = srv.dbPreparedStatements[DbPsid_GetForumById].QueryRow(forumId).Scan(
		&forum.Id,
		&forum.SectionId,
		&forum.Name,
		&forum.Threads,
...
func (srv *Server) deleteForumByIdM(forumId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_DeleteForumById].Exec(forumId)
	if err != nil {
		return err
	}
...
func (srv *Server) readForumsM() (forums []mm.Forum, err error) {
	...
	var rows *sql.Rows
	rows, err = srv.dbPreparedStatements[DbPsid_ReadForums].Query()
	if err != nil {
		return nil, err
	}
...
func (srv *Server) getSectionByIdM(sectionId uint) (section *mm.Section, err error) {
	...
	err = srv.dbPreparedStatements[DbPsid_GetSectionById].QueryRow(sectionId).Scan(
		&section.Id,
		&section.Parent,
		&section.ChildType,
		&section.Children,
...
func (srv *Server) deleteSectionByIdM(sectionId uint) (err error) {
	var result sql.Result
	result, err = srv.dbPreparedStatements[DbPsid_DeleteSectionById].Exec(sectionId)
	if err != nil {
		return err
	}
...
func (srv *Server) readSectionsM() (sections []mm.Section, err error) {
	...
	var rows *sql.Rows
	rows, err = srv.dbPreparedStatements[DbPsid_ReadSections].Query()
	if err != nil {
		return nil, err
	}
